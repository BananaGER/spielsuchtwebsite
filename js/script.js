...
const config = {
    serverInfo: {
        ...
        serverName: "Spielsucht Minecraft", /*Server name*/
        serverIp: "spielsuchtmc.de", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1096704836143173702" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    */
    ...
    atGroupsDefaultColors: {
        leleitungsebene: "rgba(255, 124, 124, 0.5)",
        management: "rgba(255, 120, 114, 1)",
        developers: "rgba(230, 83, 0, 0.5)",
        moderatoren: "rgba(11, 175, 255, 0.5)",
        builders: "rgba(247, 2, 176, 0.5)",
        supporter: "rgba(77, 181, 71, 1)"
    },
    adminTeamPage: {
        leitungsebene: [
            {
                inGameName: "StunEpic20",
                rank: "Owner",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "DYBALA122",
                rank: "Co Owner",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 120, 114, 1)"
            },
            {
                inGameName: "None",
                rank: "Secretary",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(249, 82, 114, 1)"
            }
        ],
        management: [
            {
                ...
                rank: "Head Admin",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 59, 0, 1)"
            },
            {
                inGameName: "None",
                rank: "Admin",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 41, 0, 1)"
            }
        ],
        developers: [
            {
        ...
        moderatoren: [
            {
                ...
                rank: "Moderator",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(175, 63, 100, 1)"
            },
            {
                inGameName: "CookieGameYT",
                rank: "Test Moderator",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(215, 86, 100, 1)"
            }
        ],
        builders: [
            {
